...
const Home = () => {
  ...
  const InfoCard = ({
    ...
    <motion.div
      ...
      className={`relative rounded-3xl p-6 overflow-hidden group border border-white/30 shadow-2xl backdrop-blur-md bg-white/85 bg-gradient-to-br ${cardColors[colorIndex]}`}
    >
      <div className="relative z-10">
        <div className="flex justify-between items-start">
          <div className="p-3.5 rounded-xl bg-white/95 text-indigo-700 shadow-lg">
            {icon}
          </div>
        ...
        <div className="mt-5">
          ...
          {loading ? (
            <div className="h-9 w-2/3 mt-2 rounded-lg shimmer-bg" />
          ) : (
  ...
  const TabButton = ({
    ...
    <motion.button
      ...
      className={`flex items-center px-4 py-2.5 rounded-xl text-sm font-semibold transition-all duration-200 ${
        active === name
          ? "bg-indigo-700 text-white shadow-md"
          : "text-gray-500 hover:bg-gray-50 hover:text-indigo-700"
      }`}
    >
      {icon}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10">
          ...
          <motion.div
            ...
            className="mt-5 md:mt-0 flex space-x-1.5 bg-white/90 p-1.5 rounded-xl shadow-lg border border-white/30"
          >
            <TabButton
              name="overview"
              icon={<FiActivity className="w-5 h-5" />}
